...
import '../interface/dark_mode_toggle.dart';
import '../interface/legal_policies_button.dart'; // Make sure this path is correct for LegalPoliciesLinks
...
class _StaffSettingsState extends State<StaffSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    // Resolve semantic colors from the active theme.
    final isDark = Theme.of(context).brightness == Brightness.dark;

    // Keep settings readable in both brightness modes.
