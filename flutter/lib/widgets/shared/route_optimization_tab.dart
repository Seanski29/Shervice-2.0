...
class _RouteOptimizationTabState extends State<RouteOptimizationTab> {
  ...
  Widget build(BuildContext context) {
    ...
    // Sort the visible route results.
        ...
        children: [
          ...
          if (trips.isEmpty)
            EnterpriseEmptyState(
              ...
              title: 'No trips match this route analysis',
              message:
                  'Synchronize route data or select another reporting period to continue.',
              actionLabel: 'Sync route analysis',
              onAction: widget.onSyncAction,
            )
          else ...[
            ListView.separated(
              shrinkWrap: true,
