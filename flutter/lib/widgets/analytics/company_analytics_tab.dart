...
class _CompanyAnalyticsTabState extends State<CompanyAnalyticsTab> {
  final ScrollController _companyTableScrollController = ScrollController();

  @override
  void dispose() {
    _companyTableScrollController.dispose();
    super.dispose();
  }
  ...
  Widget _companyTable(
    ...
    return Container(
      ...
      child: Scrollbar(
        controller: _companyTableScrollController,
            ...
            rows: summaries.map((item) {
              return DataRow(
                cells: [
                  ...
                  DataCell(
                    Text((item['average'] as double).toStringAsFixed(1)),
                  ),
