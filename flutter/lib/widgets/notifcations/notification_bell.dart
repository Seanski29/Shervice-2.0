...
class _NotificationBellState extends State<NotificationBell> {
  ...
  Widget _buildNotificationTab(
    ...
    if (_isLoading) return const Center(child: EnterpriseLoadingIndicator());
          ...
          Material(
            ...
            child: IconButton(
              ...
              icon: Icon(
                ...
                size: widget.iconSize.toDouble() + 2,
              ),
