...
class LegalPoliciesButton extends StatelessWidget {
  ...
  const LegalPoliciesButton({super.key, this.iconColor = Colors.grey});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (section == LegalSection.privacy ||
                        section == LegalSection.all)
                      ..._buildPrivacyNotice(context, isDark),
                    if (section == LegalSection.terms ||
                        section == LegalSection.all)
                      ..._buildTermsOfService(context, isDark),
                    if (section == LegalSection.consent ||
                        section == LegalSection.all)
                      ..._buildUserConsent(context, isDark),
                  ],
                ),
              ),
            ),
  ...
  List<Widget> _buildTermsOfService(BuildContext context, bool isDark) {
    return [
      ...
      _buildSubsectionTitle(
        context,
        '1. System Access and Authorization',
        isDark,
      ),
      _buildText(
        context,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Review the policies that govern your use of SHERVICE.',
            ...
            Wrap(
              ...
              children: [
                TextButton(
                  onPressed: () =>
                      LegalPoliciesButton.show(context, LegalSection.terms),
                ...
                TextButton(
                  onPressed: () =>
                      LegalPoliciesButton.show(context, LegalSection.privacy),
                  style: TextButton.styleFrom(
                    padding: EdgeInsets.zero,
                    minimumSize: const Size(0, 0),
                    tapTargetSize: MaterialTapTargetSize.shrinkWrap,
                ...
                TextButton(
                  onPressed: () =>
                      LegalPoliciesButton.show(context, LegalSection.consent),
                  style: TextButton.styleFrom(
                    padding: EdgeInsets.zero,
                    minimumSize: const Size(0, 0),
                    tapTargetSize: MaterialTapTargetSize.shrinkWrap,
