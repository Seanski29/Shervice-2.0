...
class OicProfileButton extends StatelessWidget {
  final String oicId;
  final String oicName;
  final String companyName;

  const OicProfileButton({
    super.key,
    required this.oicId,
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = oicName.trim().isEmpty ? 'OIC' : oicName.trim();
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _detail(theme, 'Role', 'Officer in Charge (OIC)'),
